...
/**
 * Created by Varun Ramani on 6/19/2015.
 */
public class MoviesDatabase {
    ...
    public void insertMovies(int table, ArrayList<Movie> listMovies, boolean clearPrevious) {
        ...
        Log.d("VRR","inserting entries " + listMovies.size() + new Date(System.currentTimeMillis()));
    ...
    public ArrayList<Movie> readMovies(int table) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            Log.d("VRR","loading entries " + cursor.getCount() + new Date(System.currentTimeMillis()));
            do {
